	...
	public function insert($data)
	{
		...
		if ($result_check) {
			...
			if ($result) {
				...
				$mail->Username   = "gameovertime0909@gmail.com";
				$mail->Password   = "Status99";

				$mail->IsHTML(true);
				$mail->CharSet = 'UTF-8';
				$mail->AddAddress($email, "recipient-name");
				$mail->SetFrom("gameovertime0909@gmail.com", "bookstore");
				$mail->Subject = "Xác nhận email tài khoản - BookStore";
				$mail->Body = "<h3>Cảm ơn bạn đã đăng ký tài khoản tại website BookStore</h3></br>Đây là mã xác minh tài khoản của bạn: " . $captcha . "";
